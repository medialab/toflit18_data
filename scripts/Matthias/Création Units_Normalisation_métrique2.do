 ...
 drop _merge
 keep if need_product=="1" 
 keep simplification_classification quantity_unit_ortho quantity_unit_ajustees u_conv q_conv export_import grouping_classification
 order export_import grouping_classification simplification_classification quantity_unit_ortho quantity_unit_ajustees u_conv q_conv 
 drop if simplification_classification==""
 sort export_import quantity_unit_ortho simplification_classification
