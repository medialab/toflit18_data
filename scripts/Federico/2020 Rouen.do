...
tsset year
twoway (tsline year totgrains if importexport==1, lwidth(medthick) cmissing(n)) (tsline year totgrains if importexport==0, lwidth(medthick) cmissing(n))
