...
***collapse by year
collapse (sum) value_inclusive unifiedmeasure unifiedmeasure2, by (year importexport)

***keep livres
gen q1=unifiedmeasure
gen q2=unifiedmeasure2

*** tsset
drop unifiedmeasure
drop unifiedmeasure2
reshape wide value_inclusive q1 q2 , i(year) j(importexport)
tsset year
tsfill
rename q10 import_corrected
rename q11 export_corrected
rename q20 import
rename q21 export
rename value_inclusive0 value_import
rename value_inclusive1 value_export

* graph for import

twoway (line import year , yaxis(1) ) (line import_corrected year , yaxis(1) ) (line value_import year , yaxis(2) )
