...
replace unifiedmeasure2=quantity*240 if quantity_unit_orthographic=="charges"
replace unifiedmeasure2=quantity*240 if quantity_unit_orthographic=="charge de 300 livres"
replace unifiedmeasure2=quantity*100 if quantity_unit_orthographic=="quintal"
replace unifiedmeasure2=quantity*90 if quantity_unit_orthographic=="setiers"
replace unifiedmeasure2=quantity*60 if quantity_unit_orthographic=="mines"
...
***collapse by year
collapse (sum) value unifiedmeasure2, by (year importexport)


*** tsset

reshape wide value unifiedmeasure2  , i(year) j(importexport)
tsset year

rename unifiedmeasure20 qimport
rename unifiedmeasure21 qexport
