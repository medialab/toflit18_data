...
replace unifiedmeasure=quantity*20 if quantity_unit_orthographic=="boisseau"

replace unifiedmeasure=quantity*120 if quantity_unit_orthographic=="mines"

replace unifiedmeasure=quantity*240 if quantity_unit_orthographic=="setiers"

replace unifiedmeasure=quantity*2880 if quantity_unit_orthographic=="muids"
