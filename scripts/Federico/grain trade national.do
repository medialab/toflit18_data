...
drop if sourcetype=="National Partenaires Manquants" | sourcetype=="National Partenaires Manquants"|if sourcetype=="Tableau de marchandises"
...
replace sourcetype_grains="National" if sourcetype==""
...
collapse (sum) value_inclusive, by (year sourcetype importexport totaltrade)
bysort year sourcetype importexport: gen grainpercent=value_inclusive/totaltrade*100
reshape wide value_inclusive, i(sourcetype grainpercent year) j(importexport)
